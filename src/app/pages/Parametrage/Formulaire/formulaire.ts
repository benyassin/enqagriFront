...
export class FormulairePage implements OnInit {
    ...
    openpopup(){
        ...
        window.open("/public/index.html?myParam=" + this.model.id_fields ,"popup","width=900,height=600,left=10,top=150")
    }
    opendemo(){
        window.open("/public/demo.html?myParam=" + this.model.id_fields ,"popup","width=900,height=600,right=10,top=150")
    }
    clearForm(){
        this.model = {}
    }
